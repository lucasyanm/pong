...
public:
    ...
    static void renderRect(int middleCoordX, int middleCoordY, int width, int height, UINT32 color) {
...
private:
    ...
    static void renderRectInPixels(int x0, int y0, int x1, int y1, UINT32 color) {
